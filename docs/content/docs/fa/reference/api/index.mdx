---
title: مرجع API
description: REST API پنل Heimdall — احراز هویت، inboundها، کلاینت‌ها، آمار سرور و موارد دیگر، تولیدشده از مشخصات OpenAPI.
icon: Webhook
---

پنل Heimdall یک REST API برای خودکارسازی در اختیار می‌گذارد. این صفحات از مشخصات
