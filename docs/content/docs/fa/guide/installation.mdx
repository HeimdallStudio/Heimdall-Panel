...
bash <(curl -Ls https://raw.githubusercontent.com/HeimdallStudio/Heimdall-Panel/main/install.sh) v3.4.0
```
...
[صفحهٔ releases](https://github.com/HeimdallStudio/Heimdall-Panel/releases) دانلود کنید، آن را
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/HeimdallStudio/Heimdall-Panel/main/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/HeimdallStudio/Heimdall-Panel/tree/main/deploy) در مخزن
