...
description: مدیریت Heimdall با منوی x-ui و خط فرمان — به‌روزرسانی پایدار یا dev، تغییر تنظیمات و حذف تمیز و کامل.
icon: RefreshCw
---
...
| 5     | Legacy Version (Disabled)              | نصب نسخهٔ قدیمی upstream در Heimdall غیرفعال است          |
| 6     | Uninstall                              | حذف Heimdall (در ادامه ببینید)                                |
...
- **نسخه‌های قدیمی upstream:** در Heimdall غیرفعال‌اند؛ به‌جای آن از کانال پایدار یا dev استفاده کنید.
