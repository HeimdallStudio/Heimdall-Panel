---
title: API Reference
description: The Heimdall panel REST API — authentication, inbounds, clients, server stats, and more, generated from the OpenAPI spec.
icon: Webhook
---

The Heimdall panel exposes a REST API for automation. These pages are generated from
