...
description: Complete reference for Heimdall's XUI_* environment variables — database, panel, logging, memory, and the tunnel health monitor.
icon: Variable
---

Heimdall reads its runtime configuration from `XUI_*` environment variables. On a
