...
description: Manage Heimdall with the x-ui menu and CLI — update stable or dev builds, change settings, and uninstall cleanly.
icon: RefreshCw
---
...
| 6     | Uninstall                              | Remove Heimdall (see below)                                  |
