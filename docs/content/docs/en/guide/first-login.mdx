---
title: First Login
description: Find your generated Heimdall credentials, reach the panel, enable two-factor auth, and harden it before exposing anything.
icon: KeyRound
---
...
Heimdall supports TOTP two-factor auth (compatible with Google Authenticator, Aegis,
