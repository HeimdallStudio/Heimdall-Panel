---
title: Telegram Bot
description: Connect a Telegram bot to Heimdall for commands, periodic reports, event alerts (login, CPU, node up/down), backups, and client self-service.
icon: Send
---

Heimdall can drive a Telegram bot for monitoring, alerts, backups, and remote
