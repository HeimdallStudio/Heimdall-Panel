---
title: Subscription
description: Run the Heimdall subscription server — base64/JSON/Clash formats, ports and paths, TLS, response headers, and custom templates.
icon: Rss
---
...
routing, policy) plus a `proxy` outbound pointing at the inbound. Heimdall emits a
