...
[страницы релизов](https://github.com/HeimdallStudio/Heimdall-Panel/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/HeimdallStudio/Heimdall-Panel/tree/main/deploy)
