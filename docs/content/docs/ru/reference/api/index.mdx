...
description: REST API панели Heimdall — аутентификация, входящие подключения, клиенты, статистика сервера и многое другое, сгенерировано из спецификации OpenAPI.
icon: Webhook
---

Панель Heimdall предоставляет REST API для автоматизации. Эти страницы сгенерированы
