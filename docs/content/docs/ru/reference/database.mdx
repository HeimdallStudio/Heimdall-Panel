---
title: База данных
description: Хранилища данных Heimdall — SQLite (по умолчанию) и PostgreSQL — путь к базе данных, пул соединений и миграция с SQLite на PostgreSQL.
icon: Database
---

Heimdall хранит всё — входящие подключения, клиентов, настройки — в базе данных.
