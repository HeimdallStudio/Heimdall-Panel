...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Check whether a newer Heimdall release is available on GitHub.
      url: '#check-whether-a-newer-heimdall-release-is-available-on-github'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Check whether a newer Heimdall release is available on GitHub.
        id: check-whether-a-newer-heimdall-release-is-available-on-github
      - content: >-
