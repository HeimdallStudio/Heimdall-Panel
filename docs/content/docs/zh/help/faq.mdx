...
[GitHub](https://github.com/HeimdallStudio/Heimdall-Panel) 上。
...
[发布页面](https://github.com/HeimdallStudio/Heimdall-Panel/releases)。

## 我可以在哪里获取帮助？

加入官方 Telegram 频道 [@XrayUI](https://t.me/XrayUI) 获取公告与社区支持，
或在 [GitHub](https://github.com/HeimdallStudio/Heimdall-Panel/issues) 上提交 issue。遇到常见问题时，
