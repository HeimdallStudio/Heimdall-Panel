---
title: 更新与卸载
description: 使用 x-ui 菜单和命令行管理 Heimdall——更新稳定版或开发版、修改设置，以及干净地卸载。
icon: RefreshCw
---
...
| 5     | Legacy Version (Disabled)              | Heimdall 已禁用上游旧版本安装                              |
| 6     | Uninstall                              | 移除 Heimdall（见下文）                                        |
...
- **上游旧版本：** Heimdall 已禁用此路径；请改用稳定版或开发版渠道。
